...
class Groups_Enqueue {
	...
	function public_enqueue_scripts() {
		...
		// public
		wp_register_script( 'um_groups', um_groups_url . 'assets/js/um-groups' . $suffix . '.js', array( 'jquery', 'wp-util', 'um_scripts', 'wp-i18n', 'jquery-ui-slider', 'wp-hooks', 'select2' ), um_groups_version, true );
