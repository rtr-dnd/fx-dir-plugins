...
if( ! class_exists( 'PWAFORWP_Plugin_Usage_Tracker') ) {
	...
	class PWAFORWP_Plugin_Usage_Tracker {
		...
		public function send_data( $body ) {
			$request = wp_remote_post( 
				esc_url( 'https://data.ampforwp.com/pwaforwp?usage_tracker=hello' ),
				array(
					'method'      => 'POST',
					'timeout'     => 20,
					'redirection' => 5,
		...
		public function update_block_notice( $plugin=null ) {
			...
			$block_notice = get_option( 'pwaforwp_wisdom_block_notice' );
			...
			update_option( 'pwaforwp_wisdom_block_notice', $block_notice );
		}
