...
= ページビュー数 =
最大3ドメイン、月間75,000ページビューまでご利用になれます。

= サポート =
プラグインの使用方法は、提供各サービスのマニュアルをご参照ください。
...
※本サービスは株式会社モリサワとエックスサーバー株式会社の協業で提供しております。TypeSquareは、株式会社モリサワの登録商標です。
...
= 1.2.0 =
* 3書体を追加（しまなみ、秀英にじみ丸ゴシック B、さくらぎ蛍雪）
* 新規テーマを追加（カジュアル、伝統、繊細）
* 一部の既存テーマにおける選択書体を変更（和風、レトロ）
